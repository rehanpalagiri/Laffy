...
const PAGES: Record<Slug, { title: string; body: string[] }> = {
  "privacy-notice": {
    ...
    body: [
      ...
      "When browser-side processing is available, the photo is analyzed locally. If you opt into Cloud AI Analysis and a secure Gemini endpoint is configured, a downscaled photo may be sent to Gemini only to generate the requested scan result, perform quality checks, and maintain the service.",
